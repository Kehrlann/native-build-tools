...
WARNING:  In a multi-module project, the `metadataRepository` configuration is global and applies across modules. Ensure that all modules share the same configuration.
